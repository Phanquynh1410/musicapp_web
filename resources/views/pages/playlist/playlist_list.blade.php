        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Playlist List</h6>
              <a href="{{ route('playlist.create') }}"><span class="badge badge-sm bg-gradient-success" style="margin-right: 10px; float: right; word-wrap: normal;">Add Playlist</span></a>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <thead>                 
                    <tr>
                      ...
                      <th class="text-uppercase text-center text-secondary font-weight-bolder opacity-7" >Playlist Image </th>
                      <th class="text-uppercase text-center text-secondary font-weight-bolder opacity-7" >Playlist Icon </th>
                      <th class="text-center text-uppercase text-secondary font-weight-bolder opacity-7">Playlist Name</th>
                  ...
                  @foreach($playlist as $key => $value)
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm col-md-2">
                        ...
                        <a class="badge badge-sm bg-gradient-danger" href="{{ route('playlist.destroy',$value->id_playlist) }}" > Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
                ...
                <div class="pull-right" style="margin: 20px;"  style="margin: 20px;">{{ $playlist->links() }}</div>
              </div>
            </div>
          </div>
        </div>
