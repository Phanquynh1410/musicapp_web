                ...
                <table class="table align-items-center mb-0">
                  ...
                  <thead>                 
                    <tr>
                      ...
                      <th class="text-uppercase text-center text-secondary font-weight-bolder opacity-7" >Adver Image </th>
                  ...
                  @foreach($adver as $key => $value)
                    <tr>
                      ...
                      <td class="text-center">
                            <img src="images/adver/{{$value->hinh_quangcao }}" class="" alt="user1" style="width: 100px; height: 100px;" >
                      </td>
                      <td class=" text-center">
                      ...
                      <td class="align-middle text-center text-sm " >
                        ...
                        <a href="{{ route('adver.show',$value->id_quangcao) }}"><span class="badge badge-sm bg-gradient-info " style="width: 60px;margin-top: 10px;">Detail</span></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
