          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <div style="margin: 30px;">
                  ...
                  <form action="{{ route('song.update',  $song->id_baihat) }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @method('PATCH')
                      <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="form-group">
                                  ...
                                  <input type="text" name="name"  class="form-control" placeholder="Song Name" value="{{$song -> ten_baihat}}">
                              </div>
                          </div>
                          <div class="col-xs-12 col-sm-12 col-md-12" >
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                              <div class="form-group">
                                  ...
                                  <input type="text" name="singer"  class="form-control" placeholder="Singer Name" value="{{$song -> ten_casi}}">
                              </div>
                          </div>
